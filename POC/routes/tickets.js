const {createTickets, listTickets,listHistory,statusChange,priorityChange,updateTickets,listAllTickets}=require('../controller/tickets');
...
router.route('/tickets').post(authenticateUser,createTickets).get(authenticateUser,listTickets);
